...
class HBNBCommand(cmd.Cmd):
    """
    Defines HBNBCommand console class
    """
    prompt = "(hbnb) "
    ...
    def emptyline(self):
        """
        Returns nothing when an empty line is entered.
        """
        pass

    def do_EOF(self, arg):
        """
        Defines EOF (Ctrl+D) signal to exit the program.
        """
        return True
    ...
    def default(self, arg):
        ...
        Incoming:class name(cls_nm),command method(cmd_met),extra args(e_arg)
        """
        arg_list = arg.split('.')
